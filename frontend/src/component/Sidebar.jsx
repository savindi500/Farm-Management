...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar bg-green-50 text-green-800 w-64 h-96 flex flex-col p-5 shadow-lg rounded-lg">
      ...
      <div className="mt-auto">
        <button
          ...
          className="flex items-center p-3 hover:bg-red-200 text-red-600 rounded-md transition duration-300 ease-in-out"
        >
      ...
      <div className="good-day mt-6 bg-green-100 p-4 rounded-md">
        <img
          src="https://i.pinimg.com/736x/7a/5a/dc/7a5adc3c4624304053f682fefc8610f5.jpg"
          alt="Good Day"
